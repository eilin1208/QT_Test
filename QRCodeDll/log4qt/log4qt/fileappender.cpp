...
namespace Log4Qt
{
	...
	void FileAppender::openFile()
	{
        ...
        QFileInfo file_info(mFullFileName);
	    QDir parent_dir = file_info.dir();
	    if (!parent_dir.exists())
	    {
            logger()->trace("Creating missing parent directory for file %1", mFullFileName);
        ...
        mpFile = new QFile(mFullFileName);
