...
//    this->setFixedSize(500,300);
    ...
    ui->labPlate->setFixedHeight(20);
    ui->labmessage->setFixedHeight(20);
    ui->label_3->setFixedHeight(20);
    ui->labcolor->setFixedHeight(20);
//    ui->labmessage->setFixedWidth(this->width());
//    ui->labPictrue->setFixedWidth(this->width());
//    ui->labPlate->setFixedWidth(this->width() - ui->label_2->width());
}
...
void Widget::GetPlateColor(int nColor)
{
    switch(nColor)
    {
        case VP_COLOR_BLUE:
