...
void TestFD::on_pushButton_openDev_clicked()
{
...
void TestFD::on_pushButton_closeDev_clicked()
{
...
void TestFD::on_pushButton_vehClass_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_Fare_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_Text_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_Before_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_After_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_Weight_clicked()
{
    int vehclass = ui->comboBox_vheClass->currentText().toInt();
...
void TestFD::on_pushButton_EnStation_clicked()
{
    bool ret;
...
void TestFD::on_pushButton_ClearAll_clicked()
{
    bool ret;
    ret = m_fd->ClearAll();
    if(ret)
...
void TestFD::on_pushButton_StarAlarm_clicked()
{
    bool ret;
    ret = m_fd->Alarm(true);
    if(ret)
...
void TestFD::on_pushButton_EndAlarm_clicked()
{
    bool ret;
