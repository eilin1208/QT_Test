...
#include "ui_testcardreader.h"

TestCardReader::TestCardReader(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TestCardReader)
{
    ui->setupUi(this);
    //打开设备
...
TestCardReader::~TestCardReader()
{
    delete ui;
}

void TestCardReader::getCardTollInfo(TCardTollInfo CardTollInfo)
{
...
void TestCardReader::on_pb_init_clicked()
{
...
void TestCardReader::on_pb_close_clicked()
{
...
void TestCardReader::on_pb_readcard_clicked()
{
...
void TestCardReader::on_writecard_clicked()
{
    TProCardBasicInfo ProCardBasicInfo;
       quint32 dwBalance = 0;
       TCardTollInfo CardTollInfo;
